...
public class CheckoutPage extends BaseClass {
	...
	WebElement clickshiptothisaddress;

	@FindBy(id = "spc-order-summary")
	...
	@FindBy(xpath = "/html/body/div[5]/div[1]/div/div[2]/div/div/div[2]/div/div[1]/div/div[2]/"
			+ "div/div/div/div[2]/table/tbody/tr[9]")
	WebElement totalamt;

	@FindBy(xpath = "//*[@id=\"banner-image\"]")
	WebElement clickamazon;
	@FindBy(css = "#a-popover-content-2 > div:nth-child(2) > div:nth-child(2)")
	WebElement selectreturntocart;
	@FindBy(xpath = "/html/body/div[1]/div[1]/div[3]/div[5]/div/div[2]/div[1]/div/form/div[2]/div[3]/div[4]/div/"
			+ "div[3]/div[1]/span[3]/span/input")
