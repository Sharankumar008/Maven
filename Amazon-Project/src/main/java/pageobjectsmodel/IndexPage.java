...
public class IndexPage extends BaseClass {
	...
	WebElement signinopt;
	@FindBy(xpath = "/html/body/div[1]/div[1]/div/div[2]/div[1]/a")
	WebElement urorders;
	@FindBy(xpath = "/html/body/div[1]/section/div/div[3]/ul")
	WebElement orderoptions;
	@FindBy(id = "a-autoid-1-announce")
	WebElement orderhistory;
	@FindBy(xpath = "/html/body/div[1]/section/div/div[3]/ul/li[2]")
	WebElement buyagainopt;
	@FindBy(xpath = "/html/body/div[1]/div[1]/div/div/div[3]/ul/li[4]/span")
	WebElement ntytshippedopt;
	@FindBy(xpath = "/html/body/div[1]/div[1]/div[1]/div[4]/div/ul/li[5]")
	WebElement cancelledopt;
	@FindBy(xpath = "/html/body/div[1]/div[1]/div[2]/div/div[2]/div/div[2]/div/form/div/div[2]/div")
