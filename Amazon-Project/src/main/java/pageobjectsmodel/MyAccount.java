...
public class MyAccount extends BaseClass {
	...
	@FindBy(xpath = "/html/body/div[1]/div[1]/div/div[3]/div[1]/a/div/div/div/div[2]")
	WebElement youraddressbtn;
	@FindBy(id = "ya-myab-plus-address-icon")
	WebElement addaddress;
	@FindBy(id = "address-ui-widgets-reload-url")
	WebElement addnewaddresspage;
	...
	@FindBy(id = "address-ui-widgets-original-address-block_id")
	WebElement originaladd;
	@FindBy(id = "a-autoid-9")
	WebElement saveadd;
	@FindBy(id = "ya-myab-display-address-block-0")
	WebElement cfmpage;
