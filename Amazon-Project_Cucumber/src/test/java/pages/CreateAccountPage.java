...
public class CreateAccountPage extends BaseTests {
	...
	WebElement missingcustomername;
	@FindBy(id = "auth-email-missing-alert")
	WebElement missingemail;
	@FindBy(id = "auth-password-missing-alert")
	WebElement missingpassword;
	...
	WebElement enterpasswordagain;
	@FindBy(id = "auth-continue")
	WebElement clickverifyemailbutton;
	@FindBy(xpath = "/html/body/div[1]/div[1]/div[2]/div/div[2]/div/div[2]/h4[1]")
	WebElement registererror;
